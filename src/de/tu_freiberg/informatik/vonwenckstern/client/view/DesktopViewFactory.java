...
import de.tu_freiberg.informatik.vonwenckstern.client.AppView;
...
import de.tu_freiberg.informatik.vonwenckstern.client.view.desktop.BigAcquisitionsFieldView;
import de.tu_freiberg.informatik.vonwenckstern.client.view.desktop.CardFieldView;
import de.tu_freiberg.informatik.vonwenckstern.client.view.desktop.InfoView;
import de.tu_freiberg.informatik.vonwenckstern.client.view.desktop.PlayerFieldView;
import de.tu_freiberg.informatik.vonwenckstern.client.view.desktop.Rounds1To7View;
import de.tu_freiberg.informatik.vonwenckstern.client.view.desktop.Rounds8To14View;

public class DesktopViewFactory implements ViewFactory {
	private static final AppController.Display appView = new AppView();
