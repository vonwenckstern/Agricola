...
public class AppViewMobile extends Composite implements AppController.Display {
	...
	interface Binder extends UiBinder<Widget, AppViewMobile> {
	}

	public AppViewMobile() {
